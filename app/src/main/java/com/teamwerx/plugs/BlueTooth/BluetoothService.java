...
public class BluetoothService {
    ...
    public synchronized void connect() {
        Log.d(MainActivity.TAG, "Connecting to: " + myDevice.getName() + " - " + myDevice.getAddress());
    ...
    private synchronized void setState(int state) {
        Log.d(MainActivity.TAG, "setState() " + this.state + " -> " + state);
        this.state = state;
    ...
    private void connectionLost() {
        Log.e(MainActivity.TAG, "Connection Lost");
        // Send a failure item_message back to the Activity
        Message msg = myHandler.obtainMessage(Constants.MESSAGE_SNACKBAR);
        Bundle bundle = new Bundle();
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                Log.e(MainActivity.TAG, "Create RFcomm socket failed", e);
            }
            mmSocket = tmp;
        }
        ...
        public void run() {
            try {
                ...
                Log.d(MainActivity.TAG, "Unable to connect", connectException);
                try {
                    mmSocket.close();
                } catch (IOException closeException) {
                    Log.e(MainActivity.TAG, "Unable to close() socket during connection failure", closeException);
                }
                connectionFailed();
                return;
            }
        ...
        public void cancel() {
            try {
                ...
                Log.e(MainActivity.TAG, "Close() socket failed", e);
            }
        }
    }
    ...
    public class ConnectedThread extends Thread {
        ...
        public void run() {
            Log.d(MainActivity.TAG, "Begin connectedThread");
            ...
            while (true) {
                try {
                    ...
                    Log.e(MainActivity.TAG, "Connection Lost", e);
                    connectionLost();
                    break;
                }
            }
