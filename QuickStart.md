...
1. Download the [application](https://github.com/bytemaster-0xff/plugs/raw/master/releases/app-release.apk) be sure to allow for installation of apps [from unknown sources](https://developer.android.com/distribute/marketing-tools/alternative-distribution#unknown-sources)
...
1. You should likely change the timeout on the display so it doesn't sleep from the default to something like more than 5 minutes if possible.
...
1. The base station in our case is a website.  The web address is https://www.nuviot.com, the username and password were provided in the submission.
